    ...
    return (
        <div className="container section-top">
            <div className="row">
                ...
                <Link href={`/details?id=${props.seatured[0]['id']}`} id='Hero' className="card h-100">
                        <img alt="" className="card-img-top w-100 rounded-2" src={props.seatured[0]['img1']}/>
                        <div className="card-img-overlay d-flex align-items-end">
                            <div className="caption">
                                <h4>{props.seatured[0]['title']}</h4>
                                <p>{props.seatured[0]['short_des']}</p>
                            </div>
                        </div>
                    </Link>
                </div>
